...
public class CusDevPlanService extends BaseService<CusDevPlan,Integer> {
    ...
    /*public Map<String,Object> queryCusDevPalnByParams(CusDevPlanQuery cusDevPlanQuery){
    ...
    public void saveCusDevPlan(CusDevPlan cusDevPlan){
        ...
        AssertUtil.isTrue(save(cusDevPlan)<1,"计划项添加失败！");
    }
    ...
    public void updateCusDevPlan(CusDevPlan cusDevPlan){
        ...
        AssertUtil.isTrue(update(cusDevPlan)<1,"计划项更新失败！");
    }

    public void deleteCusDevPlan(Integer[] ids){
        AssertUtil.isTrue(null==ids||ids.length==0,"请选择待删除的计划项！");
