...
<table id="dg"  class="easyui-datagrid"
       ...
       url="${ctx}/module/list?grade=1&parentId=${parentId}" fit="true" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="50" align="center">编号</th>
        <th field="moduleName" width="150" align="center" >菜单名</th>
        <th field="moduleStyle" width="100" align="center">样式</th>
        <th field="url" width="150" align="center" >URL</th>
        <th field="grade" width="100" align="center" formatter="formatterGrade">层级</th>
        <th field="optValue" width="95" align="center">权限码值</th>
        <th field="orders" width="95" align="center">排序</th>
        <th field="createDate" width="160" align="center">创建时间</th>
        <th field="updateDate" width="160" align="center" >更新时间</th>
        <th field="op" width="160" align="center" formatter="formatterOp">操作</th>
    </tr>
    </thead>
</table>
<div id="tb">
            ...
            <tr>
                ...
                <td>
                     <input id="cc" class="easyui-combobox" name="roleIds"
                            valueField="id" textField="roleName" multiple="true" url="${ctx}/role/queryAllRoles" panelHeight="auto"/>
